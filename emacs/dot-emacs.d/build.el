...
(defconst dest-elisp-dir (ha/get-path "${ha/emacs-directory}/generated-elisp"))
...
(defun ha/build-dot-files ()
  ...
  ;; Create the generated elisp directory for storing tangled files
  (ha/mkdir dest-elisp-dir)
